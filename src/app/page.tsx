...
export default function Home() {
  return (
    <main className="min-h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-zinc-100 flex flex-col selection:bg-blue-500/30 overflow-hidden relative transition-colors duration-300">
      ...
      <nav className="border-b border-zinc-200 dark:border-zinc-900/60 bg-white/60 dark:bg-zinc-950/20 backdrop-blur-md sticky top-0 z-30 w-full transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-extrabold text-sm tracking-tight text-zinc-900 dark:text-white">Next-Gen Academy</span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8 text-xs font-semibold text-zinc-500 dark:text-zinc-400">
            ...
            <a href="#testimonials" className="hover:text-zinc-900 dark:hover:text-white transition-colors">Testimonials</a>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10 w-full">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-400 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
            ...
            <a
              href="#features"
              className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-900/60 dark:hover:bg-zinc-900 text-zinc-700 hover:text-zinc-900 dark:text-zinc-300 dark:hover:text-white font-bold rounded-2xl border border-zinc-200 dark:border-zinc-800 hover:border-zinc-700 dark:hover:border-zinc-700 transition-all"
            >
              Explore Features
            </a>
          </div>
        ...
        >
          ...
          <motion.div
            ...
            className="absolute top-8 left-0 sm:left-4 p-5 bg-white dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800/90 rounded-2xl w-64 shadow-2xl backdrop-blur-md z-10"
          >
            <div className="flex justify-between items-center mb-3">
              <div className="p-2 bg-emerald-500/10 rounded-lg text-emerald-500 dark:text-emerald-400 border border-emerald-500/20">
                <Database className="h-4 w-4" />
              </div>
              <span className="text-[9px] uppercase tracking-wider font-extrabold px-2 py-0.5 bg-emerald-500/10 text-emerald-500 dark:text-emerald-400 border border-emerald-500/20 rounded-full">
                Completed
              </span>
            </div>
            <h4 className="text-xs font-bold text-zinc-900 dark:text-white mb-2.5">Supabase Backend Architecture</h4>
            ...
            <div className="flex justify-between items-center mt-3 text-[10px] text-zinc-500 font-bold">
              <span>Progress</span>
              <span className="text-emerald-500 dark:text-emerald-400">100%</span>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="absolute bottom-8 right-0 sm:right-4 p-5 bg-white dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800/90 rounded-2xl w-64 shadow-2xl backdrop-blur-md z-10"
          >
            <div className="flex justify-between items-center mb-3">
              <div className="p-2 bg-blue-500/10 rounded-lg text-blue-500 dark:text-blue-400 border border-blue-500/20">
                <Cpu className="h-4 w-4" />
              </div>
              <span className="text-[9px] uppercase tracking-wider font-extrabold px-2 py-0.5 bg-blue-500/10 text-blue-500 dark:text-blue-400 border border-blue-500/20 rounded-full">
                In Progress
              </span>
            </div>
            <h4 className="text-xs font-bold text-zinc-900 dark:text-white mb-2.5">Advanced Next.js 16 Routing</h4>
            <div className="w-full bg-zinc-100 dark:bg-zinc-800 h-1.5 rounded-full overflow-hidden">
              <div className="bg-gradient-to-r from-blue-500 to-indigo-500 h-full w-[72%] rounded-full" />
            </div>
            <div className="flex justify-between items-center mt-3 text-[10px] text-zinc-500 font-bold">
              <span>Progress</span>
              <span className="text-blue-500 dark:text-blue-400">72%</span>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="absolute p-4 bg-white dark:bg-zinc-900/90 border border-zinc-200 dark:border-zinc-800/90 rounded-2xl w-48 shadow-2xl backdrop-blur-md z-20 flex items-center gap-3.5"
          >
            ...
            <div>
              ...
              <span className="text-base font-black text-zinc-900 dark:text-white block">+28.4%</span>
            </div>
          </motion.div>
        </motion.div>
      </section>
      ...
      {/* Statistics Section */}
      <section id="stats" className="border-y border-zinc-200 dark:border-zinc-900 bg-zinc-100/40 dark:bg-zinc-950/40 relative z-10 py-16 w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-1">
              ...
              <h3 className="text-3xl sm:text-4xl font-black text-blue-600 dark:text-blue-400 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">
                120+
              </h3>
            ...
            <motion.div variants={itemVariants} className="space-y-1">
              ...
              <h3 className="text-3xl sm:text-4xl font-black text-indigo-600 dark:text-indigo-400 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400">
                4.92 / 5
              </h3>
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 z-10 relative w-full space-y-16">
        ...
        >
          ...
          <motion.div 
            ...
            className="p-6 bg-white dark:bg-zinc-900/30 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl backdrop-blur-sm space-y-4 transition-colors"
          >
            <div className="p-3 bg-blue-500/10 border border-blue-500/20 text-blue-500 dark:text-blue-400 rounded-xl inline-block">
              <Cpu className="h-5 w-5" />
            </div>
            <div className="space-y-1.5">
              <h3 className="text-sm font-bold text-zinc-900 dark:text-white">Next.js 16 Framework</h3>
          ...
          <motion.div 
            ...
            className="p-6 bg-white dark:bg-zinc-900/30 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl backdrop-blur-sm space-y-4 transition-colors"
          >
            <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 text-indigo-500 dark:text-indigo-400 rounded-xl inline-block">
              <Database className="h-5 w-5" />
            </div>
            <div className="space-y-1.5">
              <h3 className="text-sm font-bold text-zinc-900 dark:text-white">Supabase SSR Auth</h3>
              <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
          ...
          <motion.div 
            ...
            className="p-6 bg-white dark:bg-zinc-900/30 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl backdrop-blur-sm space-y-4 transition-colors"
          >
            <div className="p-3 bg-purple-500/10 border border-purple-500/20 text-purple-500 dark:text-purple-400 rounded-xl inline-block">
              <Layers className="h-5 w-5" />
            </div>
            <div className="space-y-1.5">
              <h3 className="text-sm font-bold text-zinc-900 dark:text-white">Framer Motion Animation</h3>
              <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
          ...
          >
            ...
            <div className="space-y-1.5">
              <h3 className="text-sm font-bold text-zinc-900 dark:text-white">Row Level Security</h3>
              <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
          ...
          >
            ...
            <div className="space-y-1.5">
              <h3 className="text-sm font-bold text-zinc-900 dark:text-white">WASM Fallback Engine</h3>
              <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
          ...
          >
            ...
            <div className="space-y-1.5">
              <h3 className="text-sm font-bold text-zinc-900 dark:text-white">Strict TypeScript Schema</h3>
              <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
      ...
      <section id="testimonials" className="border-t border-zinc-200 dark:border-zinc-900 bg-zinc-100/10 dark:bg-zinc-950/20 relative z-10 py-24 w-full space-y-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          >
            ...
            <motion.div 
              ...
              className="p-6 bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/60 rounded-2xl flex flex-col justify-between backdrop-blur-sm relative transition-all"
            >
              <Quote className="absolute top-6 right-6 h-10 w-10 text-zinc-200 dark:text-zinc-800/45 pointer-events-none" />
              <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 pt-6 border-t border-zinc-100 dark:border-zinc-800/40 mt-6">
                ...
                <div>
                  <h4 className="text-xs font-bold text-zinc-900 dark:text-white">Sarah K.</h4>
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-6 border-t border-zinc-100 dark:border-zinc-800/40 mt-6">
                ...
                <div>
                  <h4 className="text-xs font-bold text-zinc-900 dark:text-white">Marcus L.</h4>
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-6 border-t border-zinc-100 dark:border-zinc-800/40 mt-6">
                ...
                <div>
                  <h4 className="text-xs font-bold text-zinc-900 dark:text-white">Elena D.</h4>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10 w-full">
        <motion.div
          ...
          className="bg-gradient-to-br from-zinc-100 via-zinc-100 to-blue-50/30 dark:from-zinc-900 dark:via-zinc-900 dark:to-indigo-950/30 border border-zinc-200 dark:border-zinc-800/80 rounded-3xl p-8 sm:p-14 text-center relative overflow-hidden space-y-6"
        >
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-500/10 border border-indigo-500/20 rounded-full text-[10px] font-black uppercase tracking-wider text-indigo-500 dark:text-indigo-400">
            <Award className="h-3.5 w-3.5" />
            Interactive Progress Metrics
          </div>

          <h2 className="text-3xl sm:text-5xl font-black text-zinc-900 dark:text-white tracking-tight leading-tight max-w-2xl mx-auto">
            Ready to Accelerate Your <br /> Learning Progress?
          </h2>
          
          <p className="text-xs sm:text-sm text-zinc-600 dark:text-zinc-400 max-w-lg mx-auto leading-relaxed font-medium">
          ...
          <div className="pt-4">
            <Link
              href="/dashboard"
              className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-zinc-900 hover:bg-zinc-800 dark:bg-white dark:hover:bg-zinc-100 text-white dark:text-black font-extrabold rounded-2xl shadow-xl shadow-zinc-900/15 dark:shadow-white/5 border border-zinc-900 dark:border-white hover:border-zinc-800 dark:hover:border-zinc-200 transition-all cursor-pointer transform hover:-translate-y-0.5 active:translate-y-0 text-sm"
            >
              Enter Learning Dashboard
              <ArrowRight className="h-4 w-4 text-white dark:text-black group-hover:translate-x-1 transition-transform" />
            </Link>
          </div>
        </motion.div>
      </section>
      ...
      {/* Footer */}
      <footer className="border-t border-zinc-200 dark:border-zinc-900 bg-zinc-100/10 dark:bg-zinc-950/20 py-8 relative z-10 w-full mt-auto">
